...
<head>
  ...
  <style>
    ...
    input[type="text"], input[type="url"], textarea, button, select { /* Added select for dropdown */
      width: 100%;
      padding: 10px;
      margin-bottom: 15px;
      border-radius: 5px;
                ...
                if tmdb_id:
                    ...
                    try:
                        ...
                        if res:
                            ...
                            release_date = res.get("release_date") if tmdb_detail_type == "movie" else res.get("first_air_date") # For series
